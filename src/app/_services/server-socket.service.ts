...
export class ServerSocket {
    ...
    public connect() {
        ...
        return this.outputStream = this.socketFactory.connect(
            ...
            // 'ws://ns520442.ip-158./-69-23.net:4433/user?token='+currentUser.token,
            'wss://apis.influexpai.com/user?token='+currentUser.token,
            // 'ws://127.0.0.1:8000/chat/besties?token='+currentUser.token,
