...
@Component({
  selector: 'app-blogsearchv2',
  templateUrl: './blogsearchv2.component.html',
  styleUrls: ['./blogsearchv2.component.scss']
})
export class Blogsearchv2Component implements OnInit, AfterViewInit{
    ...
    ngOnInit() {
        ...
        this.route.queryParams.subscribe(params =>{
            ...
            if(this.qparamschecker === 'web'){
                this.inCurrentpage =true;
            }
        });
        this.currentList= JSON.parse(localStorage.getItem('selected_list'));
        this.sub = this.route.params.subscribe(params => {

            this.http.post(Config.api+'/blog/web/'+ params['query']+'/?page=1', '',{})
                .subscribe(res => {
